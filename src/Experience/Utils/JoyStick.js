export default class JoyStick {
	...
	move(evt) {
		...
		if (this.onMove!=undefined) this.onMove.call(this.game.world.character, forward, turn);
        // console.log('this.game', this.game.world.character)
	}
	...
	up(evt){
		...
		this.onMove.call(this.game.world.character, 0, 0);
	}
}
